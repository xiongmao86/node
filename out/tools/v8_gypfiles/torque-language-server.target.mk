...
$(builddir)/torque-language-server: LD_INPUTS := $(OBJS) $(obj).target/tools/v8_gypfiles/libtorque_base.a $(obj).target/tools/v8_gypfiles/libtorque_ls_base.a $(obj).target/tools/v8_gypfiles/libv8_libbase.a $(obj).target/tools/v8_gypfiles/libabseil.a
$(builddir)/torque-language-server: TOOLSET := $(TOOLSET)
$(builddir)/torque-language-server: $(OBJS) $(obj).target/tools/v8_gypfiles/libtorque_base.a $(obj).target/tools/v8_gypfiles/libtorque_ls_base.a $(obj).target/tools/v8_gypfiles/libv8_libbase.a $(obj).target/tools/v8_gypfiles/libabseil.a FORCE_DO_CMD
	$(call do_cmd,link)
