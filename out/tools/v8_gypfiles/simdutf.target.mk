...
OBJS := \
	$(obj).target/$(TARGET)/deps/v8/third_party/simdutf/simdutf.o
...
$(obj).target/tools/v8_gypfiles/libsimdutf.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/tools/v8_gypfiles/libsimdutf.a: LIBS := $(LIBS)
$(obj).target/tools/v8_gypfiles/libsimdutf.a: TOOLSET := $(TOOLSET)
$(obj).target/tools/v8_gypfiles/libsimdutf.a: $(OBJS)
	$(call create_thin_archive,$@,$^)

# Add target alias
.PHONY: simdutf
simdutf: $(obj).target/tools/v8_gypfiles/libsimdutf.a
